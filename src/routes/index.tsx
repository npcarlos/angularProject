...
// Load rider pages
const RiderListPage = lazy(() => import("../components/Pages/RidersPage/RiderList"));

const RiderDetailPage = lazy(() => import("../components/Pages/RidersPage/RiderDetail"));

// Load events/shows pages
const ShowListPage = lazy(() => import("../components/Pages/ShowsPage/ShowsList"));

const ShowDetailPage = lazy(() => import("../components/Pages/ShowsPage/ShowDetail"));

// Load Artists pages
const ArtistsListPage = lazy(() => import("../components/Pages/ArtistsPage/ArtistsList"));
const ArtistDetailPage = lazy(() => import("../components/Pages/ArtistsPage/ArtistDetail"));
